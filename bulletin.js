...
updateBtn1.addEventListener('click', (e) => {
    ...
    if(counter == 1){
        database.ref('/bulletin/' + category.value + '/' + postId + '/articleImages/').update(newImg1);
    }else{
    database.ref('/bulletin/' + category.value + '/' + postId + '/articleImages/').update(newImg2);
    }
    database.ref('/bulletin/' + category.value + '/' + postId).update(newData);
});

removeBtn1.addEventListener('click', (e) => {
    e.preventDefault();
    database.ref('/bulletin/' + category.value + '/' + postId).remove()
    .then(() => {
